Shader "TheLivingFrame/UniverseProjectionAdditive"
{
    Properties
    {
        _MainTex ("Universe Texture", 2D) = "black" {}
        _Tint ("Tint", Color) = (0.35, 0.75, 1.0, 1.0)
        _Intensity ("Intensity", Range(0, 8)) = 1.5
        _Alpha ("Alpha", Range(0, 1)) = 0.45
        _Cutoff ("Black Cutoff", Range(0, 1)) = 0.03
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                half alpha = mask * _Alpha * sampleColor.a * edgeFade;
                half3 color = sampleColor.rgb * _Tint.rgb * _Intensity * edgeFade;
